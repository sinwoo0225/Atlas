...
public static class WbsTools
{
    ...
    public static async Task<string> List(
        ...
        [Description("상태 다중 필터 (Planned|Waiting|InProgress|Done|Suspended)")] WbsStatus[]? statuses = null,
    ...
    public static async Task<string> Create(
        ...
        [Description("Planned|Waiting|InProgress|Done|Suspended")] WbsStatus? status = null,
