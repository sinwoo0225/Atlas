...
//  1) settings.ts NotificationSettings 에 하위 설정 객체 (+ load() deep-merge 도!)
//  2) SettingsPage 알림 탭에 토글/입력
//  3) locales/{ko,en}/notifications.json 에 메시지 키
export const NOTIFICATION_SOURCES: NotificationSource[] = [deadlineSource, dailySummarySource, updateSource];
