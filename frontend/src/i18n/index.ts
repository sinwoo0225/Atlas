...
const resources = {
  ...
  en: { common: enCommon, nav: enNav, status: enStatus, settings: enSettings, palette: enPalette, shortcuts: enShortcuts, dashboard: enDashboard, projects: enProjects, issues: enIssues, worklog: enWorklog, resources: enResources, activity: enActivity, devinfo: enDevinfo, changelog: enChangelog, widget: enWidget },
} as const;
...
i18n.use(initReactI18next).init({
  ...
  fallbackLng: 'ko',
  defaultNS: 'common',
  ns: ['common', 'nav', 'status', 'settings', 'palette', 'shortcuts', 'dashboard', 'projects', 'issues', 'worklog', 'resources', 'activity', 'devinfo', 'changelog', 'widget'],
