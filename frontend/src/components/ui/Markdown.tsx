...
// - rehype-highlight: 코드블록 구문 강조(highlight.js). sanitize *뒤* 에 둬야 hljs 클래스가
//                     제거되지 않는다. ignoreMissing 으로 미등록 언어 태그에도 에러 없음.
//
...
const REHYPE_PLUGINS: PluggableList = [rehypeRaw, rehypeSanitize, [rehypeHighlight, { ignoreMissing: true }]];
